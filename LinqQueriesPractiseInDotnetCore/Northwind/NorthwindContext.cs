...
namespace LinqQueriesPractiseInDotnetCore.Northwind
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<EmpChennai> EmpChennais { get; set; } = null!;
        public virtual DbSet<EmpHyd> EmpHyds { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-P2V677R;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                entity.HasKey(e => e.EmpId)
                    .HasName("PK__Employee__AF2DBB99774746CA");
            ...
            modelBuilder.Entity<Employee1>(entity =>
            {
                ...
                entity.HasMany(d => d.Territories)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        r => r.HasOne<Employee1>().WithMany().HasForeignKey("EmployeeId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_EmployeeTerritories_Employees"),
                        j =>
                        {
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                entity.HasKey(e => e.Sid)
                    .HasName("PK__student__DDDFDD36A56206BF");
